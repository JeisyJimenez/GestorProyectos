...
<body>
    ...
    <!-- Cuerpo con Cards -->
    <section class="cards">
        <!-- Tarjeta 1: Revisar Anteproyecto -->
        <div class="card">
            <div class="card-body">
                <a href="anteproyectos2.jsp">Revisar Anteproyecto</a>
                <p>Accede a la sección para revisar anteproyectos.</p>
            </div>
        </div>

        <!-- Tarjeta 2: Aprobar Anteproyecto -->
        <div class="card">
            <div class="card-body">
                <a href="aprobarAnteproyecto2.jsp">Aprobar Anteproyecto</a>
                <p>Aprobar los anteproyectos revisados.</p>
            </div>
        </div>
