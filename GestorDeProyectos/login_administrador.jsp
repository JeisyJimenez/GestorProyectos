    ...
    <div class="container mt-5">
        ...
        <%
            ...
            try {
                ...
                ps.setString(2, password); // Aquí puedes usar un hash de la contraseña si es necesario
        ...
        <%
                ...
                out.println("<p class='text-danger'>Error de conexión: " + e.getMessage() + "</p>");
            } catch (ClassNotFoundException e) {
                out.println("<p class='text-danger'>Error al cargar el driver: " + e.getMessage() + "</p>");
            } catch (Exception e) {
                out.println("<p class='text-danger'>Ocurrió un error inesperado. Intente más tarde.</p>");
            } finally {
                // Cierre de recursos
