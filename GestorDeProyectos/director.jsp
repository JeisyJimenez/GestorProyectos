...
<head>
    ...
    <style>
        ...
        * {
        ...
        .card-center {
            grid-column: span 2; /* Hace que la tarjeta ocupe 2 columnas en la grilla */
        }
...
<body>
    ...
    <!-- Cuerpo con Cards -->
    <section class="cards">
        <!-- Tarjeta 1: Calificar Anteproyecto -->
        <div class="card">
            <div class="card-body">
                <a href="calificarAnteproyecto2.jsp">Calificar Anteproyecto</a>
                <p>Accede a la sección para calificar anteproyectos.</p>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-body">
                <a href="informacionEstudiante.jsp">Información Estudiante</a>
                <p>Consulta la información de los estudiantes.</p>
            </div>
        </div>

        <!-- Tarjeta 3: Aprobar Anteproyecto -->
        <div class="card">
            <div class="card-body">
                <a href="aprobarAnteproyecto.jsp">Aprobar Anteproyecto</a>
                <p>Aprobar los anteproyectos enviados.</p>
            </div>
        </div>
