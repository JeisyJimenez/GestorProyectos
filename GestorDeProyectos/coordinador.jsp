...
<body>
    ...
    <!-- Cuerpo con Cards -->
    <section class="cards">
        <!-- Tarjeta 1: Gestionar Anteproyectos -->
        <div class="card">
            <div class="card-body">
                <a href="anteproyectos.jsp">Gestionar Anteproyectos</a>
                <p>Administra los anteproyectos de manera eficiente.</p>
            </div>
        </div>

        <!-- Tarjeta 2: Agregar Idea de Anteproyecto -->
        <div class="card">
            <div class="card-body">
                <a href="agregarIdea.jsp">Agregar Idea de Anteproyecto</a>
                <p>Proporciona nuevas ideas para anteproyectos.</p>
            </div>
        </div>
